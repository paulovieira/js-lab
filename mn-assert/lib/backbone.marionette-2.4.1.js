...
(function(root, factory) {
  ...
  Marionette.assert = function(condition, name, message, url){
      if (condition) {
          return;
      }
  ...
  Marionette.ItemView = Marionette.View.extend({
    ...
    _renderTemplate: function() {
      ...
      //Mn.assert(template, 'UndefinedTemplateError','Cannot render the template since it is null or undefined.')
  /**/
      if (!template) {
        throw new Marionette.Error({
