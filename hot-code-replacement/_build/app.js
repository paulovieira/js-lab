...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubView1 = __webpack_require__(11); 
	var SubView2 = __webpack_require__(14); 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewClass = "subview-1-vx";

	var templateHtml = `
	    <div>this is subview 1</div>
	    <button class='${ viewClass } btn-sub'>button 1</button>
	    <br>
	    <textarea></textarea>
	`;
	...
	var SubView1 = Mn.LayoutView.extend({
	    template: _.template(templateHtml),
	    ui: {
	        button: "button." + viewClass + ".btn-sub"
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templateHtml = `
	    ...
	    <button class='btn-sub'>button 2</button>
	    <br>
	    <textarea></textarea>
	`;
