...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainApp = __webpack_require__(19);
	...
	var MenuLV = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToolkitAbstractApp = __webpack_require__(8).AbstractApp;
	...
	debugger;
	        this.mergeOptions(options, ['region', 'channel', 'initialView', 'initialViewOptions']);
	    ...
	    show: function() {
	        ...
	        if(this.initialView){
	            Radio.channel("views").request("show", {
	                ...
	                viewOptions: _.extend({ initialAppView: true }, this.initialViewOptions)
	            });            
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	internals.views = {
	    MenuLV: __webpack_require__(10),
	    MapsLV: __webpack_require__(17),
	    SourcesLV: __webpack_require__(18)
	};
	...
	channel.reply("show", function(options){
	    ...
	    if(!View){
	        throw new Error("view does not exist: " + options.view);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var $ = __webpack_require__(2);
	var sourcesApp = __webpack_require__(11).sourcesApp;
	var mapsApp = __webpack_require__(11).mapsApp;

	var pic = __webpack_require__(12)
	...
	var MenuState = Mn.State.extend({
	    ...
	    onItemClicked: function(item) {
	        var item = item.substring("js-menu-".length);
	        this.set("item", item);
	    },
	...
	var MenuLV = Mn.LayoutView.extend({
	    ...
	    initialize: function(options){
	        ...
	        this.$el.addClass(options.initialAppView ? "js-initial-app-view" : "");
	    },

	    // template: _.template(`
	    //     <div>
	    //         <ul>
	    //             <li id="js-menu-maps">maps</li>
	    //             <li id="js-menu-sources">sources</li>
	    //             <li id="js-menu-sources"><%= name %></li>
	    //         </ul>
	    //     </div>
	    ...
	    onChangeItem: function(state, value, options){
	        ...
	        if(previous.item){
	            //this.stopApp(previous.item);
	            Radio.channel("mainApp").request("stop", previous.item)
	        }

	        Radio.channel("mainApp").request("start", previous.item)
...
/***/ function(module, exports) {
	...
	/*
	var MainApp = require("./main-app");
	var MapsApp = require("./maps-app");
	var SourcesApp = require("./sources-app");

	var mainApp = new MainApp({
	    x: 1
	});

	// var mapsApp = mainApp.addChildApp("mapsApp", MapsApp, { 
	//     startWithParent: false,
	//     parent: mapsApp  
	// });
	var mapsApp = new MapsApp();

	// var sourcesApp = mainApp.addChildApp("sourcesApp", SourcesApp, { 
	//     startWithParent: false,
	//     parent: mapsApp  
	// });
	var sourcesApp = new SourcesApp();

	if(NODE_ENV==="dev"){
	    window.app = window.mainApp = mainApp;
	    window.mapsApp = mapsApp;
	    window.sourcesApp = sourcesApp;
	}

	module.exports.mainApp = mainApp;
	module.exports.mapsApp = mapsApp;
	module.exports.sourcesApp = sourcesApp;
	*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "710544e7f0c828b42f51207342622d33.png";

/***/ },
/* 13 */
/***/ function(module, exports, __webpack_require__) {

	var nunjucks = __webpack_require__(14);
	var env;
	...
	var configure = __webpack_require__(15)(env);
	...
	(function() {(nunjucks.nunjucksPrecompiled = nunjucks.nunjucksPrecompiled || {})["views/menu-lv/menu-lv.html"] = (function() {
	...
	module.exports = shim(nunjucks, env, nunjucks.nunjucksPrecompiled["views/menu-lv/menu-lv.html"] , dependencies)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mn = __webpack_require__(4);
	var _ = __webpack_require__(3);
	var mainApp = __webpack_require__(11).mainApp;
